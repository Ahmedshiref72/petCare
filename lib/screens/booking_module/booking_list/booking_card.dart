...
class BookingCard extends StatelessWidget {
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                if (appointment.status.contains(BookingStatusConst.COMPLETED)) ...[
                  8.height,
                  AppButton(
                    width: Get.width,
              ...
              child: Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    12.width,
                    Text(appointment.service.name, style: primaryTextStyle(color: secondaryColor)),
                  ],
                ),
              ),
            ),
  ...
  Widget detailWidget({required String title, required String value, Color? textColor, String? prefixImage}) {
    return Row(
