...
class TrainingServiceScreen extends StatelessWidget {
  TrainingServiceScreen({Key? key}) : super(key: key);
                    ...
                    onTap: () {
                      ...
                      serviceCommonBottomSheet(context,
                          child: BottomSelectionSheet(
                            ...
                            controller: trainingController.searchCont,
                            onChanged: trainingController.onSearchChange,
                            hasError: trainingController.hasErrorFetchingTraining.value,
                            isEmpty: trainingController.isShowFullList ? trainingController.trainingList.isEmpty : trainingController.trainingFilterList.isEmpty,
                            ...
                            listWidget: Obx(
                              () => trainingListWid(
                                trainingController.isShowFullList ? trainingController.trainingList : trainingController.trainingFilterList,
                              ).expand(),
                            ),
                          ));
                    },
                        ...
                        serviceCommonBottomSheet(
                          ...
                          child: Obx(
                            () => BottomSelectionSheet(
                              ...
                              controller: trainingController.searchCont,
                              onChanged: trainingController.onTrainerSearchChange,
                              hasError: trainingController.hasErrorFetchingTrainer.value,
                              isEmpty: trainingController.isShowTrainerFullList ? trainingController.trainerList.isEmpty : trainingController.trainerFilterList.isEmpty,
                              ...
                              listWidget: Obx(
                                () => trainerListWid(
                                  trainingController.isShowTrainerFullList ? trainingController.trainerList : trainingController.trainerFilterList,
                                ).expand(),
                              ),
                            ),
                          ),
                ...
                AppTextField(
                  ...
                  onTap: () async {
                    ...
                    if (selectedDate != null) {
                      ...
                      debugPrint('trainingController.BOOKBOARDINGREQ: ${trainingController.bookTrainingReq.toJson()}');
                    } else {
