...
import 'package:pawlly/screens/shop/product/components/all_review_product_components.dart';
...
class RatingComponents extends StatelessWidget {
  ...
  RatingComponents({super.key, required this.reviewDetails, required this.productReviewData});
  final ProductDetailController productController = Get.find();

  @override
  Widget build(BuildContext context) {
    if (productReviewData.productReview.validate().isEmpty) return Text(locale.value.noRatingsYet, style: primaryTextStyle(fontFamily: fontFamilyBoldGlobal, size: 17)).paddingSymmetric(horizontal: 16);
    return Column(
      ...
      children: [
        ViewAllLabel(
            ...
            onTap: () {
              ...
              Get.to(() => AllReviewProductComponents(productId: productReviewData.id));
            }),
        Container(
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          /*  Text('${reviewData.createdAt}', style: secondaryTextStyle()),*/
                        ],
                      ),
                      14.height,
