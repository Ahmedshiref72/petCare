...
class ProductItemComponents extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () async {
        final isAddedToWhishlist = await Get.to(() => ProductDetail(), arguments: productListData);
        ...
        child: Column(
          ...
          children: [
            ...
            Column(
              crossAxisAlignment: CrossAxisAlignment.center,
              children: [
                Text(isFromWishList ? productListData.productName : productListData.name, style: primaryTextStyle(), maxLines: 1, overflow: TextOverflow.ellipsis),
                6.height,
                Marquee(
                  child: Row(
