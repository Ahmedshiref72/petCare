...
class ShopModel {
  ...
  int minPrice;
  int maxPrice;
  int taxIncludeMinPrice;
  int taxIncludeMaxPrice;
  int discountValue;
  String discountType;
  ...
  factory ShopModel.fromJson(Map<String, dynamic> json) {
    ...
    return ShopModel(
      ...
      taxIncludeMinPrice: json['tax_include_min_price'] is int ? json['tax_include_min_price'] : -1,
      taxIncludeMaxPrice: json['tax_include_max_price'] is int ? json['tax_include_max_price'] : -1,
