...
class AdditionalDetailScreen extends StatelessWidget {
  AdditionalDetailScreen({super.key});

  final GlobalKey<FormState> _additionalformKey = GlobalKey<FormState>();

  final AdditionalInfoController additionalInfoController = Get.put(AdditionalInfoController());

  @override
  Widget build(BuildContext context) {
    return AppScaffold(
      appBartitleText: locale.value.customerDetail,
      body: Stack(
        children: [
          AnimatedScrollView(
            children: [
