...
class AddPetStep1Screen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        // const StepsRow(midImg1: Assets.dogPawDogPaw, midImg2: Assets.dogPawDogPaw1).paddingSymmetric(horizontal: 16),
        16.height,
        Obx(
          () => AnimatedWrap(
            runSpacing: 16,
            spacing: 16,
            children: List.generate(addPetInfoController.petTypeList.length, (index) {
