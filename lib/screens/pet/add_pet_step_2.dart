                      ...
                      serviceCommonBottomSheet(context,
                          child: Obx(
                            () => BottomSelectionSheet(
                              ...
                              controller: addPetInfoController.searchCont,
                              onChanged: addPetInfoController.onSearchChange,
                              hasError: addPetInfoController.hasErrorFetchingBreed.value,
                              isEmpty: addPetInfoController.isShowFullList ? addPetInfoController.breedList.isEmpty : addPetInfoController.breedFilterList.isEmpty,
                              ...
                              listWidget: Obx(
                                () => breedListWid(
                                  addPetInfoController.isShowFullList ? addPetInfoController.breedList : addPetInfoController.breedFilterList,
                                ).expand(),
                              ),
                            ),
                          ));
