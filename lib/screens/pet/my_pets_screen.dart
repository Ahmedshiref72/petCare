                              ...
                              children: List.generate(pets.length, (index) {
                                ...
                                return InkWell(
                                  onTap: () {
                                    ...
                                    debugPrint('SELECTED PET PROFILE: ${myPetsScreenController.selectedPetProfile.toJson()}');
                                    Get.to(() => PetProfileScreen(), duration: const Duration(milliseconds: 600));
                                  },
                                  borderRadius: radius(),
