                                  ...
                                  Column(
                                    children: [
                                      RadioListTile(
                                        ...
                                        title: Text("${addressData.firstName} ${addressData.lastName}", style: primaryTextStyle()),
                                        subtitle: Column(
                                            ...
                                            buildIconWidget(
                                              ...
                                              onTap: () async {
                                                Get.to(() => AddAddressScreen(), arguments: addressData)?.then((value) {
                                                  debugPrint('AddAddressScreen VALUE: $value');
                                                  if (value == true) {
                                                    selectAddressController.page(1);
                                                    selectAddressController.isLoading(true);
                                                    selectAddressController.init();
                                        ...
                                        onChanged: (value) async {
                                          if (!isFromProfile) {
                                            ...
                                            /// LogisticZone Api
                                            await selectAddressController.getLogisticZoneApi(addressId: selectAddressController.setSelectedAddressData.value.id.value);
                                          }
                                        },
                                      ),
              ...
              children: [
                Obx(
                  () => Container(
                    ...
                    child: Text(locale.value.addNewAddress, style: primaryTextStyle(color: white)),
                  )
                      .onTap(() async {
