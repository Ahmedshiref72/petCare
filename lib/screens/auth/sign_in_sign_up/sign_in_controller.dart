...
import 'package:pawlly/screens/auth/model/login_response.dart';
import 'package:pawlly/screens/booking_module/booking_list/bookings_controller.dart';
...
class SignInController extends GetxController {
  ...
  googleSignIn() async {
    ...
    await GoogleSignInAuthService.signInWithGoogle().then((value) async {
      ...
      debugPrint('signInWithGoogle REQUEST: $request');
